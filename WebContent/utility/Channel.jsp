...
function confirmDelete(code){
	var dialog = $('<p>Are you sure you want to delete this Channel?</p>').dialog({
   	 width: 550,
    	 cache: false,
        buttons: {
            "<%=localeObj.getTranslatedText("Yes")%>": function() {
            	window.location.href = 'FormManager?key=ChannelAdd&type=DELETE&CHANNEL_CODE='+code;
            },
...
<div id="maincontainer">
			<div class="head">
				<h2 align="center"><%=localeObj.getTranslatedText("Channel Maintenance")%></h2>
			</div>
                       ...
                       <%
                             ...
                             <div class="MT30" >
								<table style="width:100%">
										...
										<tr><td align="left"><a href="FormManager?key=ChannelAdd&type=NEW" class="ML10 btn1 " /><%=localeObj.getTranslatedText("Add Channel")%></a></td>
							...
							<table class="subFormDesign">
								<thead>
										<tr>
											...
											<th width="10%"><label><%=localeObj.getTranslatedText("Channel Code")%></label></th>
											<th width="80%"><label><%=localeObj.getTranslatedText("Channel Name")%></label></th>
