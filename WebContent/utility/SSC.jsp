...
function confirmDelete(code){
	var str="<%=localeObj.getTranslatedText("Are you sure you want to delete this SSC?")%>";
	var dialog = $('<p>'+str+'</p>').dialog({
   	 width: 550,
    	 cache: false,
        buttons: {
            "<%=localeObj.getTranslatedText("Yes")%>": function() {
            	window.location.href = 'FormManager?key=SSCAdd&type=DELETE&SSC_CODE='+code;
            },
   	...
   	<div id="maincontainer">	
   					...
   					<div class="head"><h2 align="center"><%=localeObj.getTranslatedText("SSC Maintenance")%></h2></div>  	
...
<%=localeObj.getTranslatedText(((com.quix.aia.cn.imo.utilities.MsgObject)request.getAttribute(com.quix.aia.cn.imo.constants.RequestAttributes.MESSAGE_OBJ)).getMsg())%>
                      ...
                      <!-- -District --> 
            			...
            			<td >	
            				<select name="city" id="city"  class="comboObj"  >
           						<option value="0" >All</option>                                        	
                                		...
                                		<tr  >                         
                                    	<td style="border: none;"  >	                                    				
	                                    				<label ><%=localeObj.getTranslatedText("SSC Name")%></label>
                                    	</td>
                                        <td>	
						...
						<table style="width:100%">
								...
								<tr><td align="left"><a href="FormManager?key=SSCAdd&type=NEW" class="ML10 btn1" ><%=localeObj.getTranslatedText("Add New")%></a></td>
           		...
           		<div class="data_table  MT20 MB20" style="width:100%" >
					...
					<tr >
							<th style="width:10%"><%=localeObj.getTranslatedText("SSC Code")%></th>
							<th ><%=localeObj.getTranslatedText("SSC Name")%></th>
							<th ><%=localeObj.getTranslatedText("City Name")%></th>
