...
function confirmDelete(code){
	var dialog = $('<p>Are you sure you want to delete this Presenter Category?</p>').dialog({
   	 width: 550,
    	 cache: false,
        buttons: {
            "<%=localeObj.getTranslatedText("Yes")%>": function() {
            	window.location.href = 'FormManager?key=PresenterCategoryAdd&type=DELETE&PRESENTER_CATEGORY_CODE='+code;
            },
   	...
   	<div id="maincontainer">	
   					...
   					<div class="head"><h2 align="center"><%=localeObj.getTranslatedText("Presenter Category Maintenance")%></h2></div>  	
				                     ...
				                     if(request.getAttribute(RequestAttributes.MESSAGE_OBJ)!=null)
				                     {
				                      %>	
                                    	...
                                    	<td style="border: none;" >	                                    				
	                                    				<label ><%=localeObj.getTranslatedText("Presenter Category Name")%></label>
                                    	</td>
                                        <td>	
						...
						<table style="width:100%">
								...
								<tr><td align="left"><a href="FormManager?key=PresenterCategoryAdd&type=NEW" class="ML10 btn1" >Add Presenter Category</a></td>
		...
		<thead>
						<tr >
							<th style="width:10%"><%=localeObj.getTranslatedText("Code")%></th>
							<th ><%=localeObj.getTranslatedText("Presenter Category Name")%></th>
