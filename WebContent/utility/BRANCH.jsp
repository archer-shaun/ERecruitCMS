...
function confirmDelete(code){
	var str="<%=localeObj.getTranslatedText("Are you sure you want to delete this Branch?")%>";
	var dialog = $('<p>'+str+'</p>').dialog({
   	 width: 550,
    	 cache: false,
        buttons: {
            "<%=localeObj.getTranslatedText("Yes")%>": function() {
            	window.location.href = 'FormManager?key=BRANCHAdd&type=DELETE&BRANCH_CODE='+code;
            },
...
<div id="maincontainer">
			<div class="head">
				<h2 align="center"><%=localeObj.getTranslatedText("Branch Maintenance")%></h2>
			</div>
                      ...
                      <!-- -District -->    
                          ...
                          <!-- -Branch name  -->
                            ...
                            <input name="name" id="name" type="text" class="textObj" value=""  />
                             ...
                             <%} else {%>
                            <td>
                         	<input name="name"  id="name"   type="text" class="textObj" />
                         	</td>   
                         	 <%} %>
                           ...
                           <a href="javascript:document.BUForm.reset();" class="ML10 btn1"><%=localeObj.getTranslatedText("Clear")%></a> 
                               ...
                               <div class="MT30" >
								<table style="width:100%">
										...
										<tr><td align="left"><a href="FormManager?key=BRANCHAdd&type=NEW" class="ML10 btn1 " /><%=localeObj.getTranslatedText("Add Branch")%></a></td>
							...
							<th width="10%"><label><%=localeObj.getTranslatedText("Branch Code")%></label></th>
