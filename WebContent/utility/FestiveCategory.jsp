...
<script>
function confirmDelete(code,count){
	var str="";
	if(count==0){
		str="<%=localeObj.getTranslatedText("Are you sure you want to delete this Festive Category?")%>";
	}else{
		str="<%=localeObj.getTranslatedText("This Festive Category may contain E-Greetings uploaded by other users, please confirm to the action to delete all related E-Greetings?")%>";
	}
	...
	var dialog = $('<p>'+str+'</p>').dialog({
        ...
        buttons: {
            "<%=localeObj.getTranslatedText("Yes")%>": function() {
            	window.location.href = 'FormManager?key=FestiveCategoryAdd&type=DELETE&FESTIVE_CATEGORY_CODE='+code;
            },
...
<div id="maincontainer">
			<div class="head">
				<h2 align="center"><%=localeObj.getTranslatedText("Festive Category Maintenance")%></h2>
			</div>
...
<table class="formDesign">
			...
			<td colspan="2" style="text-align: center"><span style="color:#ec2028;">
                   ...
                   <%if(null != request.getAttribute(com.quix.aia.cn.imo.constants.RequestAttributes.MESSAGE_OBJ)){%>
                   ...
                   <%}%>                 
								...
								<table style="width:100%">
										...
										<tr><td align="left"><a href="FormManager?key=FestiveCategoryAdd&type=NEW" class="ML10 btn1 " /><%=localeObj.getTranslatedText("Add Festive Category")%></a></td>
                       ...
                       <div class="data_table  MT20 MB20" style="width:100%" >
							<table class="subFormDesign">
								<thead>
										...
										<th width="10%"><label><%=localeObj.getTranslatedText("Code")%></label></th>
										<th width="40%"><label><%=localeObj.getTranslatedText("Festive Category Name")%></label></th>
