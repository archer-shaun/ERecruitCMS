 ...
 * -----------------------------------------------------------------------------                          
 * 17-July-2015               Maunish             CandidateGroupId file added 
 ***************************************************************************** */
 ...
 * @version 1.0
 */
public class CandidateGroupId implements Serializable  {
	...
	/**
	 * <p>
	 * Default Constructor.Setting default values for CandidateGroupId
	 * fields.
	 * </p>
	 */
	public CandidateGroupId() {
		addressCode = null;
		iosAddressCode = null;
	}
